...
const PaywallDialog = ({ onClose }: { onClose?: () => void }) => {
	...
	const goToFreeGame = () => {
		// On suppose que l'index 0 est "Le mur du son" dans la liste
		window.dispatchEvent(new CustomEvent("navigateToFirstFreeGame"));
	};
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
			<div className="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full text-center border border-party-pink">
				...
				<p className="mb-4 text-party-purple">Ce jeu est exclusif. Débloquez tous les jeux pour profiter de l'expérience complète !</p>
