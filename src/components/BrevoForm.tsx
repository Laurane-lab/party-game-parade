        ...
        <div id="sib-container" className="sib-container--medium sib-container--vertical" style={{ textAlign: 'center', backgroundColor: 'transparent', maxWidth: '100%', borderRadius: '3px', borderWidth: '1px', borderColor: 'hsl(var(--border))', borderStyle: 'solid', direction: 'ltr' }}>
          <form id="sib-form" method="POST" action="https://361787f9.sibforms.com/serve/MUIFACiBIMpb5KO4CZuuu7KprviwFPd45y_ASI3j-WgQaNLeFeLOxWLvAkHfDovNkhLeXND-K3qLsTKygtqZ_PHYoTokGRNGvYaGY4mcLJVX3jSozdFp3Im8bgLzxQRnMgGChfAvSgj4R_USXXTA74p0MHZXaLEEBL82BmQHe0uvC5V6zcwdwsWS2Bf63t_o23a2WrYH0ROh6MR6" data-type="subscription" onSubmit={handleSubmit}>
            <div style={{ padding: '4px 0' }}>
              <div className="sib-form-block" style={{ fontSize: '24px', textAlign: 'left', fontWeight: 700, fontFamily: 'Helvetica, sans-serif', color: 'hsl(var(--primary))', backgroundColor: 'transparent' }}>
                <p>Plus de jeux !</p>
              </div>
            </div>
            <div style={{ padding: '4px 0' }}>
              <div className="sib-input sib-form-block">
                <div className="form__entry entry_block">
                  <div className="form__label-row ">
                    <label className="entry__label" style={{ fontWeight: 600, textAlign: 'left', fontSize: '14px', fontFamily: 'Helvetica, sans-serif', color: 'hsl(var(--foreground))' }} htmlFor="EMAIL" data-required="*">Tu veux recevoir en exclusivité les prochains jeux mis en ligne ? Donne ton adresse mail !</label>
                  ...
                  <label className="entry__specification" style={{ fontSize: '11px', textAlign: 'left', fontFamily: 'Helvetica, sans-serif', color: '#8390A4' }}>
            ...
            <div style={{ padding: '4px 0' }}>
              <div className="sib-form-block" style={{ textAlign: 'left' }}>
                <button className="sib-form-block__button sib-form-block__button-with-loader" style={{ fontSize: '14px', textAlign: 'center', fontWeight: 600, fontFamily: 'Helvetica, sans-serif', color: 'hsl(var(--primary-foreground))', backgroundColor: 'hsl(var(--primary))', borderRadius: '3px', borderWidth: '0px', padding: '4px 8px' }} form="sib-form" type="submit" disabled={status === 'submitting'}>
                  <svg className="icon clickable__icon progress-indicator__icon sib-hide-loader-icon" viewBox="0 0 512 512" style={{ display: status === 'submitting' ? 'inline-block' : 'none', width: '14px', verticalAlign: 'middle', marginRight: '6px' }}>
